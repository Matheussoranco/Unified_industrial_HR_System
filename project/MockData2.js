const mockData = {
    ...
    dashboard: {
      ...
      events: [
        ...
        { title: "Mindfulness ao Ar Livre", date: "Sexta, 08:00", description: "Meditação guiada no parque" },
      ],
      tips: [
        ...
        { title: "Sono", description: "Durma pelo menos 7-8 horas por noite para recuperação ideal" },
      ],
    },
    ...
    healthTracker: {
      physical: {
        metrics: [
          ...
          { label: "Passos Diários", value: "8500", unit: "passos" },
        ],
        activities: [
          ...
          { activity: "Yoga", duration: "20 min", intensity: "Leve", date: "Anteontem" },
        ],
      },
      mental: {
        mood: "Feliz",
        ...
        gratitude: ["Família", "Saúde", "Conquistas no trabalho"],
      },
      nutrition: {
        waterIntake: "2L",
        meals: [
          ...
          { name: "Jantar", items: ["Sopa de legumes", "Torrada integral", "Chá"] },
        ],
      },
    },
    ...
    recipes: {
      weeklyMenu: [
        ...
        { day: "Quarta", mainDish: "Tofu Grelhado", sideDish: "Macarrão Integral", salad: "Tabule", dessert: "Sorbet de Frutas" },
      ],
      communityPosts: [
        {
      ...
      featuredRecipes: [
        {
          ...
          difficulty: "Fácil",
          ingredients: ["Açaí", "Banana", "Proteína em Pó", "Granola"],
          steps: ["Misture o açaí e a banana no liquidificador.", "Adicione a proteína e misture bem.", "Decore com granola."],
        },
      ],
    },
  };
